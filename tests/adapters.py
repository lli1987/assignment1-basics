...
def run_swiglu(
    ...
    state_dict = {"weights1": w1_weight, "weights2": w2_weight, "weights3": w3_weight}
...
def run_multihead_self_attention_with_rope(
    ...
    mha = MultiHeadSelfAttention(d_model, num_heads, theta)
    mha.load_state_dict(state_dict)
    return mha.forward(in_features, token_positions, max_seq_len)
