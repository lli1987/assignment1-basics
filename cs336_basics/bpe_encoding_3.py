...
def deserialize_bpe(name, vocab_size):
    ...
    try:
        with open(PICKLE_FILE_BASE_DIR + "/" + merges_file_name, "rb") as f:
            merges = pickle.load(f)
        with open(PICKLE_FILE_BASE_DIR + "/" + vocab_file_name, "rb") as f:
            vocab = pickle.load(f)
        with open(PICKLE_FILE_BASE_DIR + "/" + st_file_name, "rb") as f:
...
class Tokenizer:
    ...
    def get_tokenizer(name, vocab_size):
        vocab, merges, special_tokens = deserialize_bpe(name, vocab_size)
